...
<body>
    ...
    try{
      String url = "jdbc:mysql://softwarepractice4.cxchxxx8qkvh.ap-northeast-2.rds.amazonaws.com:3306/course";        // 사용하려는 데이터베이스명을 포함한 URL 기술
      String id = "lunatk";                                                    // 사용자 계정
      String pw = "Thtlf1210";                                                // 사용자 계정의 패스워드
