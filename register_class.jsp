...
<head>
    ...
    function div1Resize() {
		...
		function add_time(){
			...
			var str1 = "<div class='controls'><span style=\"margin-right:10px;\">강의요일</span><input id='mon" +time_count.toString()+ "'name='day_of_class"+time_count.toString()+"' type='radio' value='0' required> <label for='mon" +time_count.toString()+ "' class='radio'>월</label> <input id='thu" +time_count.toString()+ "'name='day_of_class"+time_count.toString()+"' type='radio'value='1'> <label for='thu" +time_count.toString()+ "'class='radio'>화</label> <input id='wed" +time_count.toString()+ "' name='day_of_class"+time_count.toString()+"' type='radio' value='2'> <label for='wed" +time_count.toString()+ "' class='radio'>수</label> <input id='thr" +time_count.toString()+ "' name='day_of_class"+time_count.toString()+"' type='radio' value='3'> <label for='thr" +time_count.toString()+ "' class='radio'>목</label> <input id='fri" +time_count.toString()+ "' name='day_of_class"+time_count.toString()+"' type='radio' value='4'> <label for='fri" +time_count.toString()+ "' class='radio'>금</label></div><br>";
		...
		<form method="post">
			...
			<table style="width:400px;">
              ...
              <input name="class_year" type="number" required placeholder="수강대상학년">
					...
					<tr>
            <td>
              <input name="class_credit" type="number" required placeholder="수강학점">
            </td>
          </tr>
          <tr>
						<td>
              <div class="controls">
                <span style="margin-right:10px;">강의요일</span>
